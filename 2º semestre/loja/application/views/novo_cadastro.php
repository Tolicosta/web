			<div id="homebody">
				...
				<div class="row-fluid">
					<?php
						...
						echo form_open(base_url('cadastro/adicionar'), array('id'=>'form_cadastro')) ."<div class='span4'>" .
							...
							form_input(array('id'='sexo', 'name'=>'sexo', 'Placeholder'=>'Sexo', 'value'=>set_value('sexo'))) .
							form_input(array('id'='cep', 'name'=>'cep', 'Placeholder'=>'Cep', 'value'=>set_value('cep'))) ."</div><div class='span4'>" .
							...
							form_input(array('id'='numero', 'name'=>'numero', 'Placeholder'=>'Numero', 'value'=>set_value('numero'))) ."</div><div class='span4'>" .
							...
							form_input(array('id'='email', 'name'=>'email', 'Placeholder'=>'Email', 'value'=>set_value('email'))) .
