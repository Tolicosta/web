<?php defined('BASEPATH') OR exit('No direct script access allowed');
	class Cadastro extends CI_Controller{
		...
		public function adicionar(){
			...
			$this->form_validation->set_rules('nome', 'Nome', 'required|min_lenght[5]');
			$this->form_validation->set_rules('cpf', 'CPF', 'required|min_lenght[14]');
		...
		public function login(){
			$this->load->library('form_validation');
			$this->form_validation->set_rules('email', 'E-mail', 'requires|valid_email');
			$this->form_validation->set_rules('senha', 'Senha', 'requires');
